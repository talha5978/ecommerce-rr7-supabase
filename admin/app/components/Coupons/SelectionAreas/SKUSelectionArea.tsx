...
import type { SKUsNameListRow, SKUsNamesListResponse } from "@ecom/shared/types/products";
import { COUPONS_SKUS_PAGE_SIZE } from "@ecom/shared/constants/constants";

export const SKUsSelectionArea = memo(
	({ field, resolvedData }: SelectionAreaProps<SKUsNamesListResponse>) => {
		if (resolvedData == null) return <LineSkeleton lines={COUPONS_SKUS_PAGE_SIZE} />;
