...
import { CollectionActionData, CollectionUpdateActionData } from "@ecom/shared/schemas/collections.schema";
...
export class CollectionsService extends Service {
	...
	}): Promise<CollectionDataItemsResponse> {
	...
	async getCollectionsNamesList(
		...
		try {
			...
			const smallPageSize = COUPONS_COLLECTIONS_PAGE_SIZE;
